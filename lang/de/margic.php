...
$string['editall_help'] = 'Wenn aktiviert, können Nutzer/innen alle eigenen Einträge in einem Margic bearbeiten.';
...
$string['adderrortype'] = 'Fehlertypen anlegen';
...
$string['deletealltags'] = 'Nur alle Tags löschen';
$string['tagsdeleted'] = 'Alle Tags gelöscht';
$string['deleteallratings'] = 'Nur alle Bewertungen löschen';
$string['ratingsdeleted'] = 'Alle Bewertungen gelöscht';
...
$string['privacy:metadata:margic_errortypes'] = 'Enthält die Fehlertypen aus allen Margics.';
...
$string['privacy:metadata:margic_errortypes:userid'] = 'ID des Benutzers, der den Fehlertyp erstellt hat.';
$string['privacy:metadata:margic_errortypes:timecreated'] = 'Datum, an dem der Fehlertyp erstellt wurde.';
$string['privacy:metadata:margic_errortypes:timemodified'] = 'Zeitpunkt der letzten Änderung des Fehlertyps.';
$string['privacy:metadata:margic_errortypes:name'] = 'Name des Fehlertyps.';
$string['privacy:metadata:margic_errortypes:color'] = 'Farbe des Fehlertyps als Hex-Wert.';
