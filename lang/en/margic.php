...
$string['adderrortype'] = 'Add annotation type';
$string['errortypeadded'] = 'Annotation type added';
$string['editerrortype'] = 'Edit annotation type';
$string['errortypeedited'] = 'Annotation type edited';
$string['errortypecantbeedited'] = 'Annotation type could not be changed';
$string['deleteerrortype'] = 'Delete annotation type';
$string['errortypedeleted'] = 'Annotation type deleted';
$string['errortypeinvalid'] = 'Annotation type invalid';
$string['nameoferrortype'] = 'Name of annotation type';
...
$string['privacy:metadata:margic_errortypes'] = 'Contains the annotation types of all margics.';
...
$string['privacy:metadata:margic_errortypes:userid'] = 'ID of the user that made the annotation type.';
$string['privacy:metadata:margic_errortypes:timecreated'] = 'Date on which the annotation type was created.';
$string['privacy:metadata:margic_errortypes:timemodified'] = 'Time the annotation type was last modified.';
$string['privacy:metadata:margic_errortypes:name'] = 'Name of the annotation type.';
$string['privacy:metadata:margic_errortypes:color'] = 'Color of the annotation type as hex value.';
