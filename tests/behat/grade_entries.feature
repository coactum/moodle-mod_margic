...
Feature: Teacher can view, comment and grade students entries
  ...
  Background:
    ...
    And I am on "Course1" course homepage
    And I follow "Test margic name"
    And I should see "margic question"
    And I press "Start new day or edit current day margic entry"
    And I set the following fields to these values:
  ...
  Scenario: Teacher can access students entries from the margics list page
    When I follow "Course 1"
    And I turn editing mode on
    And I add the "Activities" block
    And I click on "margics" "link" in the "Activities" "block"
    Then I should see "margic question" in the "Test margic name" "table_row"
    And I should see "View 2 margic entries" in the "Test margic name" "table_row"
    And I follow "View 2 margic entries"

  Scenario: Teacher grades and adds/edits feedback to student's entries
    When I follow "Test margic name"
    And I should see "margic question"
    And I follow "View 2 margic entries"
    Then I should see "Student 1 first reply" in the "//table[@class='margicuserentry']/descendant::td[@class='userfullname'][contains(., 'Student 1')]/ancestor::table[@class='margicuserentry']" "xpath_element"
    And I should see "Student 2 first reply" in the "//table[@class='margicuserentry']/descendant::td[@class='userfullname'][contains(., 'Student 2')]/ancestor::table[@class='margicuserentry']" "xpath_element"
    ...
    And I follow "Test margic name"
    And I follow "View 2 margic entries"
    And I should see "Entry has changed since last feedback was saved" in the "//table[@class='margicuserentry'][contains(., 'Student 1')]" "xpath_element"
    And I should see "Student 1 edited first reply" in the "//table[@class='margicuserentry'][contains(., 'Student 1')]" "xpath_element"
    And I should not see "Entry has changed since last feedback was saved" in the "//table[@class='margicuserentry'][contains(., 'Student 2')]" "xpath_element"
    And I should see "Student 2 first reply" in the "//table[@class='margicuserentry'][contains(., 'Student 2')]" "xpath_element"
